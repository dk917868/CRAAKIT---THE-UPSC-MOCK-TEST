...
$res = mysqli_query($link, "select * from mock_questions_dummy where `DateOfPaper`=$DateOfPaper");
// $res1 = mysqli_query($link, "select * from questions where Subject=$Subject");
                            ...
                            <div class="col-lg-6">
                                <div class="card">
                                    ...
                                    <div class="card-body card-block">
                                        ...
                                        <div class="form-group"><label for="vat" class=" form-control-label">Subject</label><input type="text" name="examSubject" placeholder="EDIT subject" class="form-control" value="<?php echo $Subject; ?>"></div>
...
if (isset($_POST["submit1"])) {
    ...
    mysqli_query($link, "update exam_category set category='$_POST[examname]', Subject='$_POST[examSubject]',exam_time_in_minutes='$_POST[examtime]' where id=$id") or die(mysqli_error($link));
