    ...
    <div class="container-fluid">
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                ...
                <div class="marquee">
                    <div>Welcome to upsc prelims exam you can prepare yourself by taking mock exam from craakit | The upcoming UPSC mock will be on 28/04/2023 (kindly prepare well)</div>
                </div>
            </div>
            <div class="card-body" style="min-height: 600px;">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        ...
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold text-danger ">Important Dates</h6>
                            </div>
                            <div class="card-body" style="overflow-x: scroll; overflow-x:hidden; max-height: 450px;">
                                <ul>
                    ...
                    <div class="col-lg-4">
                        ...
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold text-success">What's New?
                                </h6>
                            </div>
                            <div class="card-body">
                        ...
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold text-info">UPSC Prelims </h6>
