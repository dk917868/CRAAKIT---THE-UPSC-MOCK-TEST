...
$res = mysqli_query($link, "select * from mock_questions where DateOfPaper='$_SESSION[DateOfPaper]' && question_no='$_GET[questionno]' order by question_no asc");
	...
	<table style="margin-left:30px">
		<tr>
			...
			<td style="padding-left: 10px">
				...
				?>
					<img src="admin/<?php $opt1; ?>" height="30" width="30">
				<?php
				} else {
					echo $opt1;
				}
		...
		<tr>
			...
			<td style="padding-left:10px">
				...
				?>
					<img src="admin/<?php $opt2; ?>" height="30" width="30">
				<?php
				} else {
					echo $opt2;
				}
		...
		<tr>
			...
			<td style="padding-left:10px">
				...
				?>
					<img src="admin/<?php $opt3; ?>" height="30" width="30">
				<?php
				} else {
					echo $opt3;
				}
		...
		<tr>
			...
			<td style="padding-left:10px">
				...
				?>
					<img src="admin/<?php $opt4; ?>" height="30" width="30">
				<?php
				} else {
					echo $opt4;
				}
