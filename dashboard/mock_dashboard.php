    ...
    <div class="container-fluid">
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                ...
                <div class="h4 font-weight-bold text-dark" style="text-align: center"><?php echo "You are taking " . $_SESSION['DateOfPaper'] . " Mock Test" ?></div>
            </div>
            <div class="card-body">
                <div class="row">
                    <br>
                ...
                <div style="padding-left: 30px; min-height: 280px;" id="load_mock_questions">
        ...
        xmlhttp.onreadystatechange = function() {
            if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
                if (xmlhttp.responseText == "over") {
                    ...
                    // document.getElementById("load_mock_questions").addEventListener("click", function() {
...
<script type="text/javascript">
    function disableDashboardOptions() {
        // Get a reference to the dashboard options
        var options = document.getElementById("totalque");
...
<script type="text/javascript">
    function enableDashboardOptions() {
        // Get a reference to the dashboard options
